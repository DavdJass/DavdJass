...
| 2026 | **Talent Land Hackathon** | 🧩 Hackathon | 🏙️ CDMX, Mexico | 🔥 Semifinal |
| 2025 | **RaiseYourHack** by LabLab.ai | 🧩 Hackathon | 🌍 Worldwide Remote | 🎯 Qualifying Round |
| 2025 | **TalentLand Hackathon** | 🧩 Hackathon | Jalisco, Mexico | 🔥 Semifinal |
...
<img src="https://skillicons.dev/icons?i=cs,dotnet,git,sqlserver&theme=dark" />

<sub>C# · .NET · Git · SQL Server · Algorithms & Data Structures · Design Patterns</sub>

<br/><br/>

**📈 Familiar with**

<img src="https://skillicons.dev/icons?i=react,ionic,angular,cpp,py,nodejs,js,docker,linux,fastapi,html,css,azure&theme=dark" />

<sub>React · Ionic · Angular · C++ · Python · Node.js · JavaScript · Docker · Linux/WSL · FastAPI · HTML/CSS · Motoko (ICP Blockchain) · Azure</sub>
